...
<div id="pjNotificationContent">
	...
	<input type="hidden" name="calendar_id" value="<?php echo $controller->_get->toInt('calendar_id'); ?>">
	...
	<div class="ibox float-e-margins settings-box">
		...
		<div class="ibox-content">
			...
			<div class="notification-area<?php echo $tpl['arr']['is_active'] && $is_ready ? NULL : ' hidden'; ?>">
				...
				<div class="clearfix">
                    <button type="button" class="ladda-button btn btn-primary btn-lg pull-left btn-phpjabbers-loader pjRpbBtnSaveNotify" data-style="zoom-in">
